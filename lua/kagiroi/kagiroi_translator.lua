...
function Top.init(env)
    ...
    --     charsetFile = "lua/kagiroi_matrix_temp.bin"
    -- else
    --     -- 其他前端：正常用 fallback 找到 user/shared 目录里的绝对路径
    --     charsetFile = wanxiang.get_filename_with_fallback("lua/kagiroi_matrix_temp.bin") or "lua/kagiroi_matrix_temp.bin"
    -- end
    -- env.matrix_lookup = ReverseDb(charsetFile)
    ...
    env.matrix_lookup = kagiroi.Thunk(function()
            ...
            return ReverseDb("lua/kagiroi_matrix_temp.bin")
    end)
